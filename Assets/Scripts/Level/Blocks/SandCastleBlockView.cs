...
namespace Level.Blocks {
    public class SandCastleBlockView : BlockView {
        private int _meshId;
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/SandCastle/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/SandCastle/DefaultMaterial");
        }
