...
namespace Level.Blocks {
    public class CactusBlockView : BlockView {
        private int _meshId;
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/Cactus/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/Cactus/DefaultMaterial");
        }
