...
namespace Level.Blocks {
    public class TableCandlesBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>(Block.GetMetadataBoolean(MetadataSnapshots.MetadataInverse.Key)
                ? "Models/Blocks/TableCandles/Model2" 
                : "Models/Blocks/TableCandles/Model1");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/TableCandles/DefaultMaterial");
        }
    }
}