...
namespace Level.Blocks {
    public class ChairFancyBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/ChairFancy/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/ChairFancy/DefaultMaterial");
        }
    }
}