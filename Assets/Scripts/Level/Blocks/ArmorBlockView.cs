...
namespace Level.Blocks {
    public class ArmorBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/Armor/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/Armor/DefaultMaterial");
        }
    }
}