...
namespace Level.Blocks {
    public class ShelvesBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/Shelves/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/Shelves/DefaultMaterial");
        }
    }
}