...
namespace Level.Blocks {
    public class CauldronBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/Cauldron/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/Cauldron/DefaultMaterial");
        }
    }
}