...
namespace Level.Blocks {
    public class ArmorStandBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/ArmorStand/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/ArmorStand/DefaultMaterial");
        }
    }
}