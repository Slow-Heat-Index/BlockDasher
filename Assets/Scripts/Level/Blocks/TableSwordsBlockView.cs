...
namespace Level.Blocks {
    public class TableSwordsBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/TableSwords/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/TableSwords/DefaultMaterial");
        }
    }
}