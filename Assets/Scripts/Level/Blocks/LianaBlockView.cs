...
namespace Level.Blocks {
    public class LianaBlockView : BlockView {
        ...
        protected override Mesh LoadMesh() {
            return Resources.Load<Mesh>("Models/Blocks/Liana/Model");
        }

        protected override Material LoadMaterial() {
            return Resources.Load<Material>("Models/Blocks/Liana/DefaultMaterial");
        }
    }
}