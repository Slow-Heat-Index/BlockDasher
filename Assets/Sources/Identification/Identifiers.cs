namespace Sources.Identification {
    public static class Identifiers {
        ...
        public static readonly Identifier
            TableCandles = new Identifier(Identifier.BlockDasherProvider, "table_candles");
        ...
        public static readonly Identifier TallGrassDesert =
            new Identifier(Identifier.BlockDasherProvider, "tall_grass_desert");
        ...
        public static readonly Identifier
            BeachFlowers = new Identifier(Identifier.BlockDasherProvider, "beach_flowers");

        public static readonly Identifier BeachBigFlowers =
            new Identifier(Identifier.BlockDasherProvider, "beach_big_flowers");
